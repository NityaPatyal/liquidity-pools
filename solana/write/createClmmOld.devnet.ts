...
export async function createClmmPool(
  ...
  try {
    ...
    console.log(
      ` Pool created: https://explorer.solana.com/tx/${txId}?cluster=devnet`
    );
...
const base58Key =
  "3GLmNNC3fBrbejFu5fyZyDa1ZJjR3mojfWtJdNe11eJKZ8wk7QPXpnXUJXgAnD5sjHzkxqVx7tbJwHvzQiCGBR8A";
const mint1 = "HPr1d9xkK7nEpPmmz5AXYFvhwDaWCpYJijdN6ahjacpz";
const mint2 = "3EQuMtXi4A9FjfAikJQwKor37wVAo2HgUEYyHevfY6BT";
